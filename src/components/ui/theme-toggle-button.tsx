...
/**
 * Advanced theme toggle button with smooth view transition animations
 * Supports multiple animation variants and start positions
 * @component
 */
export default function ThemeToggleButton({
  ...
  showLabel = false,
  url = "",
}: ThemeToggleAnimationProps): React.ReactElement {
  const { theme, setTheme } = useTheme()

  const styleId = "theme-transition-styles"

  const updateStyles = React.useCallback((css: string, _name: string): void => {
